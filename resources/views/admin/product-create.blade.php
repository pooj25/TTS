...
<head>
    ...
    <title>Add Product | Admin | Track Tech Solutions</title>
    ...
    <main class="max-w-4xl mx-auto px-6 py-10">
        ...
        <div class="mt-4 mb-8">
            ...
            <p class="text-slate-500 mt-2">
                Add a new product to the Track Tech Solutions website.
            </p>
        ...
        >
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    name="name"
                    value="{{ old('name') }}"
                    placeholder="Example: TrackPro Production"
                    required
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    name="category"
                    value="{{ old('category') }}"
                    placeholder="Example: Production Management"
                    class="w-full px-4 py-3 rounded-lg
                           border border-slate-300
                           focus:outline-none
                           focus:ring-2 focus:ring-slate-900
