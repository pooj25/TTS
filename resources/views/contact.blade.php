...
@section('content')
    ...
    <section class="py-24 relative">
        <div class="absolute inset-0 bg-black/20 border-t border-b border-slate-200 pointer-events-none"></div>
        ...
        <div class="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
            ...
            <div class="grid lg:grid-cols-2 gap-16">
                ...
                <div>
                    ...
                    <div class="mt-10 space-y-7">
                        ...
                        <div class="flex gap-5 group">
                            ...
                            <div class="w-12 h-12 rounded-xl bg-white/5 border border-slate-300 flex items-center justify-center text-xl group-hover:scale-110 group-hover:bg-sky-500/20 group-hover:border-sky-500/30 transition">
                                📧
                            </div>

                            <div>
                                <h3 class="font-bold text-slate-800 group-hover:text-sky-400 transition">Email Us</h3>
                        ...
                        <div class="flex gap-5 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-800 group-hover:text-sky-400 transition">Location</h3>
                        ...
                        <div class="flex gap-5 group">
                            ...
                            <div>
                                <h3 class="font-bold text-slate-800 group-hover:text-sky-400 transition">Call Us</h3>
                    ...
                    <!-- SMALL CTA -->
                    <div class="mt-12 p-8 rounded-3xl glass-panel relative overflow-hidden group border border-slate-300">
                ...
                <!-- CONTACT FORM -->
                <div class="glass-card rounded-3xl p-8 lg:p-10 border border-slate-300">
                    ...
                    <form action="{{ route('contact.store') }}"
                        ...
                        <div class="grid md:grid-cols-2 gap-6">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    class="w-full px-5 py-4 rounded-xl border border-slate-300 bg-white/5 text-slate-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition"
                                    required>
                            </div>
                        ...
                        <div>
                            ...
                            <select
                                name="interested_in"
                                class="w-full px-5 py-4 rounded-xl border border-slate-300 bg-white/5 text-slate-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition [&>option]:bg-gray-900">
