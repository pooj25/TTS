...
<head>
    ...
    <title>Add Resource | Track Tech Solutions</title>
            ...
            <div class="px-6 py-5 flex items-center justify-between">
                ...
                <div>
                    ...
                    <p class="text-sm text-slate-500 mt-1">
                        Create a new resource for your website.
                    </p>
                ...
                >
                    ...
                    <div class="mb-6">
                        ...
                        <input
                            ...
                            name="title"
                            value="{{ old('title') }}"
                            placeholder="Example: Digital Transformation Guide"
                            required
                    ...
                    <div class="mb-6">
                        ...
                        <textarea
                            name="description"
                            rows="7"
                            placeholder="Enter the complete resource description..."
                            class="w-full px-4 py-3 rounded-xl
                                   border border-slate-300
                                   focus:outline-none focus:ring-2
                                   focus:ring-slate-900"
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="Article"
                                    {{ old('type') == 'Article' ? 'selected' : '' }}>
                                    Article
                                </option>

                                <option value="Case Study"
                                    {{ old('type') == 'Case Study' ? 'selected' : '' }}>
                                    Case Study
                                </option>

                                <option value="Whitepaper"
                                    {{ old('type') == 'Whitepaper' ? 'selected' : '' }}>
                                    Whitepaper
                                </option>

                                <option value="Guide"
                                    {{ old('type') == 'Guide' ? 'selected' : '' }}>
                                    Guide
                                </option>
