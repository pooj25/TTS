...
<head>
    ...
    <title>Edit Service | Track Tech Solutions</title>
    ...
    <main class="max-w-5xl mx-auto px-6 py-8">
        ...
        <div class="mt-5 mb-8">
            ...
            <p class="text-slate-500 mt-1">
                Update the details of this Track Tech service.
            </p>
            ...
            <div class="p-6 sm:p-8 space-y-7">
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-400 mt-2">
                        Short description used for service cards.
                    </p>
                ...
                <div class="rounded-xl bg-slate-50 border border-slate-200 p-4">
                    ...
                    <p class="text-xs text-slate-400 mt-2">
                        Slug will automatically update based on the service title.
                    </p>
